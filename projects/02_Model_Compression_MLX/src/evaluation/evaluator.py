...
class CompressionEvaluator:
    ...
    def _calculate_comparison_metrics(
        ...
        try:
            ...
            if ("avg_inference_time_ms" in original_results and 
                "avg_inference_time_ms" in compressed_results):
            ...
            if ("memory_usage_mb" in original_results and 
                "memory_usage_mb" in compressed_results):
            ...
            if ("cross_entropy_loss" in original_results and 
                "cross_entropy_loss" in compressed_results):
    ...
    def generate_evaluation_report(self, output_path: Optional[Path] = None) -> str:
        ...
        if "perplexity_increase_percent" in comparison:
            report_lines.append(f"Perplexity Increase: {comparison['perplexity_increase_percent']:.1f}%")
